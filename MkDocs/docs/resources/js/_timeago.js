...
(function () {
    ...
    TimeAgo = (function () {
        ...
        TimeAgo.prototype.updateTime = function () {
            ...
            self = this;
            return this.$element
                .findAndSelf(this.options.selector)
                .each(function () {
                    var timeAgoInWords;
                    timeAgoInWords = self.timeAgoInWords(
                        $(this).attr(self.options.attr)
                    );
        ...
        TimeAgo.prototype.updateInterval = function () {
            ...
            if (this.$element.findAndSelf(this.options.selector).length > 0) {
                ...
                if (
                    newestTimeInMinutes >= 0 &&
                    newestTimeInMinutes <= 44 &&
                    this.startInterval !== 60000
                ) {
                    this.startInterval = 60000;
                    return this.restartTimer();
                } else if (
                    newestTimeInMinutes >= 45 &&
                    newestTimeInMinutes <= 89 &&
                    this.startInterval !== 60000 * 22
                ) {
                    this.startInterval = 60000 * 22;
                    return this.restartTimer();
                } else if (
                    newestTimeInMinutes >= 90 &&
                    newestTimeInMinutes <= 2519 &&
                    this.startInterval !== 60000 * 30
                ) {
                    this.startInterval = 60000 * 30;
                    return this.restartTimer();
                } else if (
                    newestTimeInMinutes >= 2520 &&
        ...
        TimeAgo.prototype.timeAgoInWords = function (timeString) {
            ...
            return (
                "" +
                this.options.lang.prefixes.ago +
                this.distanceOfTimeInWords(absolutTime) +
        ...
        TimeAgo.prototype.distanceOfTimeInWords = function (absolutTime) {
            ...
            if (dim === 0) {
                return (
                    "" +
                    this.options.lang.prefixes.lt +
                    " " +
                    this.options.lang.units.minute
                );
            } else if (dim === 1) {
                ...
                return (
                    "" +
                    this.options.lang.prefixes.about +
                    " 1 " +
                    this.options.lang.units.hour
                );
                ...
                return (
                    ...
                    " " +
                    this.options.lang.units.months
                );
                ...
                return (
                    ...
                    this.options.lang.prefixes.about +
                    " 1 " +
                    this.options.lang.units.year
                );
            } else if (dim >= 655200 && dim <= 914399) {
                return (
                    "" +
                    this.options.lang.prefixes.over +
                    " 1 " +
                    this.options.lang.units.year
                );
                ...
                return (
                    "" +
                    this.options.lang.prefixes.almost +
                    " 2 " +
